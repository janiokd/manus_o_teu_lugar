...
export function SettingsProvider({ children }: SettingsProviderProps) {
  ...
  useEffect(() => {
    if (storageAvailable) {
      ...
      setThemeLayout('horizontal' as ThemeLayoutValue);
      setThemeStretch(false as ThemeStretchValue);
  ...
  const onToggleLayout = useCallback(() => {
    setThemeLayout('horizontal');
    setCookie('themeLayout', 'horizontal');
  }, []);
